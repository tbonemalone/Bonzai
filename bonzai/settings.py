# Django settings for bonzai project.
...
# DATABASE_NAME = 'pages.db'			   # Or path to database file if using sqlite3.
...
# SECRET_KEY = 'u^2xvgpo8ee2*_tg9xe47$nw7iikgi-y&zbi7-zaa259&cgxm5'
# 
